...
bind("XF86AudioPlay", hl.dsp.exec_cmd("qs ipc call music playPause"), { locked = true })
bind("XF86AudioPause", hl.dsp.exec_cmd("qs ipc call music playPause"), { locked = true })
bind("XF86AudioNext", hl.dsp.exec_cmd("qs ipc call music next"), { locked = true })
bind("XF86AudioPrev", hl.dsp.exec_cmd("qs ipc call music previous"), { locked = true })
bind("XF86AudioStop", hl.dsp.exec_cmd("qs ipc call music stop"), { locked = true })
bind(
    "XF86MonBrightnessDown",
    hl.dsp.exec_cmd(scripts .. "/brightness_control down"),
