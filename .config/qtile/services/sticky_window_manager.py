...
class StickyWindowManager:
    ...
    def _pin_window(
            self,
            window: libqtile.backend.base.Window) -> typing.NoReturn:
    ...
    def toggle_sticky_window(
            self,
            qtile: libqtile.core.manager.Qtile) -> typing.NoReturn:
    ...
    def _check_translate_available(
        self,
        window: libqtile.backend.base.Window,
        group_name: str
    ) -> bool:
